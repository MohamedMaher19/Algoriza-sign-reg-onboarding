        ...
        body:SingleChildScrollView(
          child: Column(
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextUtils(text: 'Register', fontSize: 27, fontWeight: FontWeight.bold, color: blackColor),
                          const Spacer(),
                      ...
                      const SizedBox(height: 10,),
                      TextUtils(text: 'Email', fontSize: 18, fontWeight: FontWeight.normal, color: blackColor),
                      const SizedBox(height: 10,),
                      ...
                      const SizedBox(height: 10,),
                      TextUtils(text: 'Password', fontSize: 18, fontWeight: FontWeight.normal, color: blackColor),
                      ...
                      SignRegisterButton(fontSize:15, textColor: whiteColor, buttonColor: blueColor, text: 'Register',
                        onPressed: () {
                      ...
                      Row(
                        ...
                        children: [
                          TextUtils(text: 'Has any account ?', fontSize: 15, fontWeight: FontWeight.normal, color: darkClr),
                          TextButton(onPressed:(){
                            navigationTo(context, LoginScreen());

                          } , child: TextUtils(text: 'Sign in here', fontSize: 15, fontWeight: FontWeight.bold, color: blueColor))
                        ],
                      ),
              ...
              TextUtils(text: 'By registerd your account , you are agree to ', fontSize: 13, fontWeight: FontWeight.normal, color: greyColor , align: TextAlign.center,),
              TextUtils(text: 'Terms and Conditions', fontSize: 13, fontWeight: FontWeight.normal, color: blueColor , align: TextAlign.center),
              const SizedBox(height: 20,)
